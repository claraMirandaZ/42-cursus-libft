...
void	*ft_calloc(size_t num, size_t size)
{
	...
	result = malloc(num * size); // Reservar memoria contigua de tamaño num * size
  // El resultado se almacena en la variable result
	...
	{
		ft_bzero(result, (num * size)); // Inicializar el bloque de memoria reservado con ceros usando bt_bzero
